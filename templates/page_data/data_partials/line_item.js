...
const data = `
  ...
  unit_price_measurement: "{{line_item.unit_price_measurement | escape}}",
  url: "{{line_item.url | escape}}",
  variant: {{line_item.variant | escape}},
